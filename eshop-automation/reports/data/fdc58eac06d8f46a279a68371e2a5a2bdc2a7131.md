...
- Name: fr07-shopping-cart.spec.js >> FR-07: Giỏ hàng (Shopping Cart) - Complete Data-Driven Test Suite >> TC06: Nhập số lượng không hợp lệ vào giỏ hàng (qty = "0")
- Location: tests\fr07-shopping-cart.spec.js:120:5

# Error details

```
Error: Giá trị không hợp lệ "0" không được phép giữ nguyên trong giỏ
