...
- Name: fr07-shopping-cart.spec.js >> FR-07: Giỏ hàng (Shopping Cart) - Positive Cases >> TC02: Thêm cùng một sản phẩm vào giỏ (Bug FR-07 trùng dòng)
- Location: tests\fr07-shopping-cart.spec.js:37:5
...
Locator: locator('.quantity-input').first()
Expected: "2"
Timeout: 5000ms
