...
- Name: fr07-shopping-cart.spec.js >> FR-07: Giỏ hàng (Shopping Cart) - Positive Cases >> TC05: Xóa sản phẩm phải hiển thị confirm dialog (Negative/Edge - Bắt Bug)
- Location: tests\fr07-shopping-cart.spec.js:96:5

# Error details

```
Error: Phải có confirm dialog khi xóa sản phẩm khỏi giỏ hàng
