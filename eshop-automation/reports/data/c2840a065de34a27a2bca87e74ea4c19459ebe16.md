...
- Name: fr07-shopping-cart.spec.js >> FR-07: Giỏ hàng (Shopping Cart) - Positive Cases >> TC04: Nhập số lượng không hợp lệ vào giỏ hàng (Negative)
- Location: tests\fr07-shopping-cart.spec.js:70:5
...
Call log:
  - waiting for locator('.quantity-input').first()
...
- generic [ref=f2e3]:
  ...
  - main [ref=f2e10]:
    - generic [ref=f2e11]:
      - heading "Giỏ hàng của bạn đang trống" [level=2] [ref=f2e12]
      - link "Tiếp tục mua sắm" [ref=f2e13] [cursor=pointer]:
        - /url: /
  - contentinfo [ref=f2e14]: © 2026 EShop SUT. Dành cho mục đích kiểm thử.
```
