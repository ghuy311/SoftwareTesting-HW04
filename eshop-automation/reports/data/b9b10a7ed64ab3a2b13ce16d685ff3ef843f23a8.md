...
- Name: fr07-shopping-cart.spec.js >> FR-07: Giỏ hàng (Shopping Cart) - Complete Data-Driven Test Suite >> TC03: Thêm nhiều sản phẩm khác nhau và tính tổng tiền giỏ hàng
- Location: tests\fr07-shopping-cart.spec.js:59:3
...
Locator: locator('text=iPhone 15 Pro Max')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=iPhone 15 Pro Max')
